...
import io.artcreativity.auth.infrastructure.security.CustomUserDetailsService;
import io.artcreativity.auth.infrastructure.security.JwtAuthenticationEntryPoint;
import io.artcreativity.auth.infrastructure.security.JwtAuthenticationFilter;
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                .requestMatchers(
                                        ...
                                        mvcMatcherBuilder.pattern("/api/auth/checkedtoken"),
                                        mvcMatcherBuilder.pattern("/api/auth/newpassword"),
                                        mvcMatcherBuilder.pattern("/api/auth/refresh-token")
                                )
                                .permitAll()
